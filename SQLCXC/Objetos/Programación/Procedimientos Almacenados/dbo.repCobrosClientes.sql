...
-- Ultimo Cambio:	11/12/2018
-- Descripción:		Reporte de Saldo de Clientes
-- =============================================
ALTER PROCEDURE [dbo].[repCobrosClientes]
    @Empresa AS CHAR(3),
    @dInicio AS DATE,
    @dFin AS DATE,
...
BEGIN
    ...
    FROM dbo.Venta AS v
        ...
        INNER JOIN dbo.Art AS a2
            ON a.Rama = a2.Articulo
               AND a2.Cuenta IN ( '101-010-101', '101-010-102', '101-010-202', '101-010-301', '101-010-201',
                                  '101-010-302', '101-010-303', '101-010-401', '101-015-200', '101-010-203',
                                  '101-015-300', '101-020-200', '101-020-300', '101-010-311', '101-010-312',
                                  '101-015-106', '101-015-108'
                                )
    ...
    FROM dbo.Cxc AS c
        ...
        INNER JOIN dbo.Concepto AS c3
            ON c.Concepto = c3.Concepto
               AND c3.Modulo = 'CXC'
               AND c3.Cuenta IN ( '101-010-101', '101-010-102', '101-010-202', '101-010-301', '101-010-201',
                                  '101-010-302', '101-010-303', '101-010-401', '101-015-200', '101-010-203',
                                  '101-015-300', '101-020-200', '101-020-300', '101-010-311', '101-010-312',
                                  '101-015-106', '101-015-108'
                                )
    ...
    FROM dbo.Cont AS c
        INNER JOIN dbo.ContD AS cd
            ON c.ID = cd.ID
               AND cd.Cuenta IN ( '101-010-101', '101-010-102', '101-010-202', '101-010-301', '101-010-201',
                                  '101-010-302', '101-010-303', '101-010-401', '101-015-200', '101-010-203',
                                  '101-015-300', '101-020-200', '101-020-300', '101-010-311', '101-010-312',
                                  '101-015-106', '101-015-108'
                                )
